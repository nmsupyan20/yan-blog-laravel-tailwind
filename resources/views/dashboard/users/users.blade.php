<x-dashboard.dashboard>
    ...
    <div class="table-wrapper overflow-x-auto mt-4 shadow-md rounded-lg">
        @php
            $titleTables = ["No.", "Name", "Username", "Email", "Action"]    
        @endphp
                        ...
                        <tr class="bg-white border-b border-gray-200 hover:bg-purple-100">
                            ...
                            <td class="px-6 py-4 flex items-center justify-start gap-2">
                                <a href="/users/{{ $user->id }}"
                                    class="text-yellow-400 bg-purple-800 hover:bg-white hover:text-purple-800 hover:ring hover:ring-purple-800 rounded-lg text-sm px-5 py-2.5"><i
                                        data-feather="eye" class="size-[1rem]"></i></a>
                                <a href="/users/{{ $user->id }}/edit"
                                    class="text-black bg-yellow-400 hover:bg-yellow-300 rounded-lg text-sm px-5 py-2.5"><i
                                ...
                                <form class="inline" method="post" action="/users/{{ $user->id }}">
                                    ...
                                    <button type="submit"
                                        ...
                                        onclick="return confirm('Apakah anda yakin ingin menghapus user ini?')"><i
                                            data-feather="trash" class="size-[1rem]"></i></button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
